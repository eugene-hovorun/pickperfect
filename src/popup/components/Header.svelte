...
<header class="flex flex-col gap-2 p-4 pb-3">
  ...
  <div class="flex items-center justify-between">
    ...
    >
      ...
      {#if isPremium}
        <span
          class="text-[9px] font-bold px-1.5 py-0.5 bg-gradient-to-br from-amber-200/50 to-orange-200/50 text-foreground rounded tracking-wider ml-1"
        >
          ✨ PRO
        </span>
      {/if}
  ...
  <!-- Row 2: Format pills -->
  <FormatPills {formats} current={currentFormat} onswitch={onformatchange} />
</header>
